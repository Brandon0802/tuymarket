...
let PanelAdminPage = class PanelAdminPage {
    ...
    doughnutChartMethod1() {
        ...
        this.doughnutChart1 = new chart_js__WEBPACK_IMPORTED_MODULE_5__.Chart(this.doughnutCanvas1.nativeElement, {
            type: 'pie',
            data: {
                labels: ['BJP', 'Congress', 'AAP', 'CPM', 'SP', 'A'],
                datasets: [{
                        label: '# of Votes',
                        data: [50, 29, 15, 10, 7, 2],
    ...
    doughnutChartMethod3() {
        ...
        this.doughnutChart3 = new chart_js__WEBPACK_IMPORTED_MODULE_5__.Chart(this.doughnutCanvas3.nativeElement, {
            type: 'doughnut',
            data: {
                labels: ['BJP', 'Congress', 'AAP', 'CPM', 'SP', 'A'],
                datasets: [{
...
PanelAdminPage.propDecorators = {
    doughnutCanvas1: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_9__.ViewChild, args: ['doughnutCanvas1',] }],
    doughnutCanvas2: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_9__.ViewChild, args: ['doughnutCanvas2',] }],
    doughnutCanvas3: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_9__.ViewChild, args: ['doughnutCanvas3',] }],
    barCanvas: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_9__.ViewChild, args: ['barCanvas',] }]
};
PanelAdminPage = (0,tslib__WEBPACK_IMPORTED_MODULE_10__.__decorate)([
